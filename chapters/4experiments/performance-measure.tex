...
\begin{equation}
%TODO: This solution for the norm-subscript produces a compilation error. If no other solution exists, comment this in at the END
%	\epsilon_s = \norm{\ps-\psest}_{\raisebox{-1pt}{_2}}.
	\epsilon_s = \norm{\ps-\psest}_{2}.
	\label{eq:error}
\end{equation}
...
%TODO: Korrektur "Stärker ausführen oder weglassen" verarbeite
