...
\centering
    ...
    \input{plots/schwartz2014-variation/s=2-sloc=schwartz2014-T60=0.7-prior=schwartz2014-unlucky-results}
		}
...
\centering
    \iftoggle{quick}{%
		\includegraphics[width=\textwidth]{plots/schwartz2014-variation/s=2-sloc=schwartz2014-T60=0.7-prior=equal-results}
			...
			\setlength{\figurewidth}{\textwidth}
    \input{plots/schwartz2014-variation/s=2-sloc=schwartz2014-T60=0.7-prior=equal-results}
		}
