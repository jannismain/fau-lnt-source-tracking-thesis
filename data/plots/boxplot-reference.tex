...
table {%
0.91 0.570710678118655
1.09 0.570710678118655
1.09 0.976485552705722
0.91 0.976485552705722
0.91 0.570710678118655
};
\addplot [line width=0.5pt, color0, opacity=1, forget plot]
table {%
...
\addplot [line width=0.5pt, color0, forget plot]
table {%
0.955 1.53501585870364
1.045 1.53501585870364
};
...
\addplot [line width=0.5pt, color0, opacity=1, forget plot]
table {%
0.91 0.707134582144651
1.09 0.707134582144651
};
\addplot [line width=0.5pt, color0, dashed, mark=x, mark size=9, mark options={solid}, forget plot]
table {%
1 0.929542795255198
};
\end{axis}
